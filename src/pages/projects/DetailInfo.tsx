    ...
    <>
      ...
      <div className="flex justify-between mb-5">
        <a href={project.url} target="_blank" rel="noreferrer">
          <span className="px-5 py-3 rounded-xl block text-center bg-header-gradient animate-gradient-breathe-fast hover:opacity-95 transition font-semibold">
            Открыть проект полностью
          </span>
        </a>
        <a href={project.githubUrl} target="_blank" rel="noreferrer">
          <span className="px-5 py-3 rounded-xl border block text-center border-indigo-300/40 hover:bg-white/5 transition font-semibold">
